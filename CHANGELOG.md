...
## 0.5.2-dev
 ...
 - NEW Features
    ...
    - Add last_cmd_failed binary sensor, which is set to true if the last attempt to send a bluetooth command was not successful. Thanks to top-gun https://github.com/top-gun for suggestion this feature, see https://github.com/tesla-local-control/tesla_ble_mqtt_docker/discussions/110
