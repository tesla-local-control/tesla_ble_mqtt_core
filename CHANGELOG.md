...
## 0.5.2-dev
 ...
 - NEW Features
    ...
    - Add last_cmd_failed binary sensor, which is set to 'on' if the last attempt to send a command was not successful. This could be because the bluetooth communication failed or the command was rejected by the car. Thanks to top-gun https://github.com/top-gun for suggestion this feature, see https://github.com/tesla-local-control/tesla_ble_mqtt_docker/discussions/110
