...
setup_auto_discovery() {
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/binary_sensor/${DEV_ID}/presence/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/generate_keys/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/deploy_key/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/config",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/scan_bluetooth/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/config",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/wake/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/flash-lights/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/honk/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/lock/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/unlock/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/auto-seat-climate/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/climate-off/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/climate-on/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/trunk-open/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/trunk-close/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/frunk-open/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/charging-start/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/charging-stop/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/charge-port-open/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/charge-port-close/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/windows-close/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/button/${DEV_ID}/windows-vent/config -m \
  '{
   "command_topic": "'${TOPIC_ROOT}'/command",
   "device": {
    "identifiers": [
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/number/${DEV_ID}/charging-set-amps/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/number/${DEV_ID}/charging-set-limit/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/number/${DEV_ID}/climate-temp/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/switch/${DEV_ID}/sw-heater/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/switch/${DEV_ID}/sentry-mode/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/select/${DEV_ID}/heated_seat_left/config -m \
  '{
 ...
 $MOSQUITTO_PUB_BASE -t homeassistant/select/${DEV_ID}/heated_seat_right/config -m \
  '{
