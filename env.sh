...
export TC_COMMAND_TIMEOUT=${TC_COMMAND_TIMEOUT:-5}
export TC_CONNECT_TIMEOUT=${TC_CONNECT_TIMEOUT:-10}
export TC_KILL_TIMEOUT=${TC_KILL_TIMEOUT:-25}
export POLL_STATE_LOOP_DELAY=${POLL_STATE_LOOP_DELAY:-30}
...
export OPTIMISTIC_MODE=${OPTIMISTIC_MODE:-false}
export IMMEDIATE_UPDATE=${IMMEDIATE_UPDATE:-true}
...
log_info "Configuration Options are:
  TC_COMMAND_TIMEOUT=$TC_COMMAND_TIMEOUT
  TC_CONNECT_TIMEOUT=$TC_CONNECT_TIMEOUT
  TC_KILL_TIMEOUT=$TC_KILL_TIMEOUT
  POLL_STATE_LOOP_DELAY=$POLL_STATE_LOOP_DELAY
  DEBUG=$DEBUG
