...
export PRESENCE_DETECTION_LOOP_DELAY=${PRESENCE_DETECTION_LOOP_DELAY:-}
if [ -z "$PRESENCE_DETECTION_LOOP_DELAY" ]; then
  PRESENCE_DETECTION_LOOP_DELAY=120
fi
export PRESENCE_DETECTION_TTL=${PRESENCE_DETECTION_TTL:-}
if [ -z "$PRESENCE_DETECTION_TTL" ]; then
